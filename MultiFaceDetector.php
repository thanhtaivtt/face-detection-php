...
class MultiFaceDetector
{
    ...
    public function faceDetect($file,$tmpfile)
    {
        ...
        if (is_resource($file)) {
            ...
            $this->canvas = $file;
			$this->tmpcanvas = $tmpfile;

        } elseif (is_file($file)) {

            $this->canvas = imagecreatefromjpeg($file);
			$this->tmpcanvas = imagecreatefromjpeg($tmpfile);
    ...
    public function toJpeg()
    {
		...
		/*
		imagejpeg($this->canvas, 'file.jpg');

		if($this->faceDetect('file.jpg'));		
        $this->toJpeg();
